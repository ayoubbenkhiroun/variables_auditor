  ...
  reader.onload = function(e) {
    try {
      ...
      if (data.scenario && Array.isArray(data.scenario.tasks)) {
        ...
        document.getElementById('roiDevCost').value = Number(currentScenario.devCost) || 0;
        document.getElementById('roiLicenseStartCost').value = Number(currentScenario.licenseStartCost) || 0;
        document.getElementById('roiScenarioSelect').value = 'custom';
        localStorage.setItem('roi_selected_preset', 'custom');
